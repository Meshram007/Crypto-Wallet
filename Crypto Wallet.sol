...
contract CryptoCoinWallet is ERC20, Ownable {
    ...
    */
    ...
    //fallback function used to receive the ether from the other addresses
   ...
   //are transfered otherwise not Transfered
    ...
    error LessCoins(uint256 requested, uint256 Available);
    ...
    //withdraw quantity
    error LessCoinsInWallet(uint256 withdraw, uint256 AvailableInWallet);
    
    
    //send coins to the recipient address 
    address recipient;
    function Send_Coins(address _recipient, uint256 coins) public {
    ...
    function CoinsUsedByRecipient(address _recipient, uint256 coins) public {
        recipient = _recipient;
        ...
        AvailableCoins[recipient] = AvailableCoins[recipient].sub(coins);
    }
